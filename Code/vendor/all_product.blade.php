						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="{{URL::to('/edit-category/'. $v_product->category_id )}}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="{{URL::to('/delete-category/'. $v_product->category_id )}}" id="delete">
