					...
					<div class="box-content">
						...
						@foreach($order_by_id as $v_order)					  	 
							<tr>
				             ...
				             <td>{{$v_order->book_name}}</td> 
				             <td>{{$v_order->book_price}}</td>
				             <td>{{$v_order->book_sales_quantity}}</td> 
                             <td>{{$v_order->book_price*$v_order->book_sales_quantity}}</td> 
							</tr>
							@endforeach
